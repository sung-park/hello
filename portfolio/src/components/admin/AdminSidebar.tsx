...
const NAV_ITEMS = [
  ...
  { href: '/admin/certifications', label: '자격증', icon: Award },
  { href: '/admin/awards', label: '수상', icon: Trophy },
  { href: '/admin/patents', label: '특허', icon: Lightbulb },
  { href: '/admin/publications', label: '발표/출판', icon: Mic },
  { href: '/admin/languages', label: '어학', icon: Languages },
  { href: '/admin/skills', label: '스킬', icon: Wrench },
